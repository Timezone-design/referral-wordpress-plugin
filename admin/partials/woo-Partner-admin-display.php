                ...
                <table class="form-table">
                    <tbody>
                        <tr>
                            ...
                            <th><label><?php _e("Actions"); ?></label></th>
                        </tr>
                        <?php foreach ($referral_info_table_data as $iter) { ?>
                            <tr>
                                ...
                                <td class="inp"><?php echo get_site_url() . "/" . $iter->referral_link ?></td>
                                <td class="inp"><?php echo get_site_url() . "/" . $iter->product_link ?></td>
                                <td class="inp"><?php echo $iter->used_times + 0 ?></td>
